        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              placeholder="Pesquisar por palavra-chave ou termo no FAQ..."
              className="w-full px-4 py-3 pl-11 rounded-xl bg-white dark:bg-carbon-950 border border-zinc-200 dark:border-carbon-800 text-sm text-slate-900 dark:text-ash-100 placeholder:text-slate-400 dark:placeholder:text-ash-500 focus:outline-none focus:ring-2 focus:ring-slate-400 dark:focus:ring-ash-500 transition-colors shadow-2xs"
            />
            <Search className="absolute left-3.5 top-3.5 w-4 h-4 text-slate-400 dark:text-ash-500" aria-hidden="true" />
          </div>
        </div>
              ...
              >
                ...
                >
                  <div className="flex flex-col gap-1 pr-2">
                    <span className="font-mono text-[10px] uppercase tracking-widest text-slate-500 dark:text-ash-400">
                  ...
                  <span className="shrink-0 font-mono text-lg text-slate-500 dark:text-ash-400 font-bold">
                    {isOpen ? '−' : '+'}
                  </span>
                </button>
